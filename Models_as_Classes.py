...
from tensorflow.keras.layers import Conv2D, MaxPooling2D, Activation, Flatten, Dropout, Dense  # For Model Building
from tensorflow.keras.optimizers import Adam  # Model compiler optemizer
from tensorflow.keras.preprocessing.image import ImageDataGenerator  # For Make From 1 image multi images
from tensorflow.keras.utils import to_categorical  # For preprocessing
...
class CNN:
    ...
    dataDir = 'C:/Users/Ahmed Wanas/Downloads/ezyZip/dataset/dataset/'  # dataset directory 
    batch_size = 128
...
class ANNHOG:
    ...
    characters = []
    IMG_SIZE = 100
    dataDir = 'C:/Users/Ahmed Wanas/Downloads/ezyZip/dataset/dataset/'
    ...
    def recognize(self, img):
        ...
        index = np.argmax(prediction)
        # print("this image for : ",self.characters[index])
        return self.characters[index]
